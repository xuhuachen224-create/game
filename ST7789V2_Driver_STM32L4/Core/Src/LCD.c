...
static const uint16_t palette_game[16] = {
    // 0~7：8级灰度（背景用）
    RGB565_BLACK,        // 0 纯黑
    RGB565_DARK_GREY,    // 1 深灰1
    0x0C63,              // 2 深灰2
    RGB565_GREY,         // 3 中灰1
    0x18C6,              // 4 中灰2
    RGB565_LIGHT_GREY,   // 5 浅灰1
    0xDEFB,              // 6 浅灰2
    RGB565_WHITE,        // 7 纯白
    
    // 8~15：游戏彩色（和你原来的默认调色板颜色完全一样！）
    LCD_COLOUR_0,  // 8 黑色（原来的0）
    LCD_COLOUR_1,  // 9 白色（原来的1）
    LCD_COLOUR_2,  //10 红色（原来的2）
    LCD_COLOUR_3,  //11 绿色（原来的3）
    LCD_COLOUR_4,  //12 蓝色（原来的4）
    LCD_COLOUR_5,  //13 橙色（原来的5）
    LCD_COLOUR_6,  //14 黄色（原来的6）
    LCD_COLOUR_7   //15 粉色（原来的7）
};
